...
void math21_generic_tensor_sub_set_or_get_cuda(NumN n, void *x, void *y, NumN dims,
    ...
    if (type == m21_type_NumR) {
        math21_template_tensor_sub_set_or_get_cuda(n, (NumR *) x, (NumR *) y, dims, dx, dy, offset, isGet);
    } else if (type == m21_type_NumR32) {
        math21_template_tensor_sub_set_or_get_cuda(n, (NumR32 *) x, (NumR32 *) y, dims, dx, dy, offset, isGet);
    } else if (type == m21_type_NumR64) {
        math21_template_tensor_sub_set_or_get_cuda(n, (NumR64 *) x, (NumR64 *) y, dims, dx, dy, offset, isGet);
    } else {
