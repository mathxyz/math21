...
void math21_ml_function_softmax_tree_opencl(PointerFloatWrapper input, int in_class_size, int mini_batch_size, int stride, float temp, PointerFloatWrapper output, m21tree hier);
