...
void math21_ml_function_average_pooling_forward_cuda(mlfunction_average_pooling *f, const mlfunction_node*finput)
{
...
void math21_ml_function_average_pooling_backward_cuda(mlfunction_average_pooling *f, mlfunction_node *finput)
{
    size_t n = f->c*f->batch;
